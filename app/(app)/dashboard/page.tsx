...
import { streak, weeklyProgress } from '@/lib/metrics';
import { getWeeklyGoal } from '@/lib/settings';
import { computeStats } from '@/lib/stats';
import { DEFAULT_WEEKLY_GOAL, type Application } from '@/lib/types';
...
export default async function DashboardPage() {
  ...
  try {
    [applications, weeklyGoal] = await Promise.all([getAllApplications(), getWeeklyGoal()]);
  } catch (e) {
